...
for easy access. From your home directory on one of the Carlson CIS servers, 
type the following commands:
\begin{verbatim}
$ mkdir lsqt-tutorial && cd lsqt-tutorial
$ BIN_LSQT=/cis/phd/mgs8033/layered-sqt/bin
...
Let's start with something mind-numbingly simple---a 100\% reflective
Lambertian surface.
